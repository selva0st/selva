...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = (
        f"**قام مطورين السورس بتحديث سيلفا**\n**التـغييرات\n** {changelog}"
    )
...
async def update(event, repo, ups_rem, ac_br):
    ...
    jasme = await event.edit(
        "**-  تم تحديث سورس سيلفا بنجاح انتظر قليلا سوف نخبرك بعد اعادة التشغيل !**"
    )
...
async def upstream(event):
    ...
    event = await edit_or_reply(
        event, "**🔺￤ يـتـم البـحـث عـن تـحديثـات سـورس سيلفا انـتـظـر**"
    )
    ...
    if changelog == "" and not force_update:
        await event.edit(
            "**🔺￤ سورس سيلفا محدث الى اخر اصدار **\n🔺￤"
            f"**قـنـاة سـورس سيلفا** : @SU_SELVA"
        )
        return repo.__del__()
    ...
    if conf == "الان":
        await event.edit("**🔺￤ جار تحـديـث سـورس سيلفا انـتـظـر قـليـلا 🔨**")
